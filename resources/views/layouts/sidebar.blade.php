...
<div class="list-group list-group-flush">
  <a href="/mhs" class="list-group-item list-group-item-action {{ (request()->isi('mhs')) ? 'active' : '' }}">Mahasiswa</a>
  <a href="#" class="list-group-item list-group-item-action">Dosen</a>
  <a href="/prodi" class="list-group-item list-group-item-action {{ (request()->isi('prodi')) ? 'active' : '' }}">Program Studi</a>
