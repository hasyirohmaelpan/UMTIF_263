...
@section('content')
    ...
    <div class="form-group row">
        <label for="nim" class="com-sm-12">NIM</label>
        <div class="com-sm-3">
    ...
    <div class="form-group row">
        <label for="nim" class="com-sm-12">Nama Lengkap</label>
        <div class="com-sm-3">
            <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" placeholder="Masukkan Nama Dengan Benar">
            @error('nama_lengkap')<small id="nama_lengkap" class="form-text text-danger">{{ $message }}</small>@enderror
        </div>
    </div>
    <div class="form-group row">
        <label for="nim" class="com-sm-12">Program Studi</label>
        <div class="com-sm-3">
